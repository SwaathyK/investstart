...
import { X, CheckCircle2, XCircle, ChevronRight, ChevronLeft, Trophy, TrendingUp, TrendingDown, AlertTriangle, Target } from 'lucide-react'
      ...
      <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col animate-slide-up">
          ...
          {completed && showResults ? (
            <div className="text-center py-8 animate-fade-in">
              ...
              <div className="space-y-4 mb-6">
                <h4 className="text-lg font-semibold text-gray-900 text-left">Step-by-Step Review:</h4>
                {steps.map((step, idx) => {
                  const selected = selectedAnswers[idx]
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <h5 className="font-semibold text-gray-900 mb-1">Step {step.stepNumber}: {step.title}</h5>
                ...
                {selectedOption && (showResults || completed) && (
                  <div className={`mt-4 p-4 rounded-lg ${
                    ...
                    <p className="text-sm font-semibold mb-1">
                      {selectedOption.isCorrect ? '✓ Correct Choice!' : 'Explanation:'}
                    </p>
        ...
        <div className="border-t border-gray-200 px-4 sm:px-6 py-4 bg-gray-50 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="text-xs sm:text-sm text-gray-600 text-center">
            {completed ? 'Review Results' : `Step ${currentStep + 1} / ${steps.length}`}
          </div>
          ...
          {completed ? (
            ...
            >
              {showResults ? (currentStep < steps.length - 1 ? 'Next Step' : 'View Results') : 'Submit Answer'}
